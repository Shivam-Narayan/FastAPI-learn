...
def upgrade() -> None:
    ...
    op.create_index('ix_connections_metadata_gin', 'connections', ['metadata'], unique=False, postgresql_using='gin')
    ...
    op.create_index(op.f('ix_agent_tools_connection_id'), 'agent_tools', ['connection_id'], unique=False)
    op.create_index(op.f('ix_agent_tools_id'), 'agent_tools', ['id'], unique=False)
    op.create_index(op.f('ix_agent_tools_provider_key'), 'agent_tools', ['provider_key'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_agent_tools_provider_key'), table_name='agent_tools')
    op.drop_index(op.f('ix_agent_tools_id'), table_name='agent_tools')
    op.drop_index(op.f('ix_agent_tools_connection_id'), table_name='agent_tools')
    op.drop_index(op.f('ix_agent_tools_agent_id'), table_name='agent_tools')
    op.drop_table('agent_tools')
    op.drop_index('ix_connections_metadata_gin', table_name='connections', postgresql_using='gin')
